...
public class BukenService {
	...
	// 賃貸の新規
	public void insertTintai(HttpSession session,String dropdown1Value, String dropdown2Value) {
	    ...
	    tintai.setOkyaku(userName);
	    tintai.setTintaiBukenId(propertyId);
	    tintai.setShinsaA("dropdown1Value");
	    tintai.setShinsaB("dropdown2Value");
	...
	public void updateShinsaStatusByBukenId(Long bukenId) {
		List<Shinsa> shinsaList = shinsaRepository.findByBukenId(bukenId);
